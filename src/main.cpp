...
int main(int argc, char* argv[])
{
    ...
    {
        std::clog << "xjulia " << XEUS_JULIA_VERSION  << std::endl;
        return 0;
    }
    ...
    // std* streams. When a user then tries to start a new kernel, xjulia
    ...
    using interpreter_ptr = std::unique_ptr<xeus_julia::interpreter>;
    interpreter_ptr interpreter = interpreter_ptr(new xeus_julia::interpreter());
